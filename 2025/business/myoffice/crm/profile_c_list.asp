...
<head>
    ...
    <link rel="stylesheet" href="/2025/css/profile_c_list.css?ver=0131">
</head>
<body>
        ...
        <div class="underline_box">
            <div class="underline_orderlist">
                <div class="search_group">
                    <a href="/2025/business/myoffice/crm/profile_c_write.asp"><button class="check_btn">등록하기</button></a>
                ...
                <div class="gl_table_wrap">
                    <table class="gl_table">
                        <thead>
                            <tr>
                                <th data-column="1-column">고객명</th>
                                <th data-column="2-column">전화번호</th>
                                <th data-column="3-column">등록일</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td data-column="1-column">고길동</td>
                                <td data-column="2-column">010-2345-4954</td>
                                <td data-column="3-column">2025.01.09</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
