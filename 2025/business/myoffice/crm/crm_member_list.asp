...
<head>
    ...
    <link rel="stylesheet" href="/2025/css/crm_member_list.css?ver=0131">
</head>
<body>
...
<div class="wrap">
    ...
    <div class="main_contents">
        ...
        <div class="box_tab">
            ...
            <a href="/2025/business/myoffice/crm/crm_member_list.asp" class="tab active">직접등록고객</a>
            ...
            <div class="underline_orderlist">
                ...
                <div class="gl_table_wrap">
                    <table class="gl_table">
                        <thead>
                            <tr>
                                <th data-column="1-column">고객번호</th>
                                <th data-column="2-column">고객명</th>
                                <th data-column="3-column">전화</th>
                                <th data-column="4-column">휴대폰</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td data-column="1-column">M25000003</td>
                                <td data-column="2-column">고구마</td>
                                <td data-column="3-column">010-2353-4389</td>
