...
<head>
    ...
    <link rel="stylesheet" href="/2025/css/crm_member_view_online.css?ver=0135">
                ...
                <div class="top_box_bg">
                    ...
                    <div class="list_line">
                        <div class="list_full">
                            ...
                            <div class="list_left_02 memo_box">
                                <textarea name="memo" id="memo" class="input_text_style" placeholder=""></textarea>
                    ...
                    <table class="gl_table">
                        <thead>
                            <tr>
                                ...
                                <th data-column="5-column">사용기한</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td data-column="5-column">2025.10.22</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
