...
<head>
    ...
    <link rel="stylesheet" href="/2025/css/index.css?ver=059">
    <link rel="stylesheet" href="/2025/css/main.css?ver=059">
    <link rel="stylesheet" href="/2025/css/login.css?ver=059">
</head>
<body>
<div class="wrap">
    ...
    <div class="login_wrap">
        <div class="login_box">
            ...
            <div class="input_line">
                <input class="input_box" id="id_box" type="id" placeholder="아이디 : 디슈머 번호 or 일반 아이디">
            </div>
            <div class="input_line">
                <input class="input_box" id="password_box" type="password" placeholder="비밀번호 : 숫자, 문자 조합 8자리 이상">
            </div>
            ...
            <div class="search_line">
                ...
                <div class="disumer_btn">디슈머 등록</div>
                <div class="customer_btn">소비회원 등록</div>
