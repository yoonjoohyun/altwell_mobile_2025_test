...
<!--#include file="components/top_navi.asp" -->
    ...
    <div class="main_contents">
        ...
        <div class="best_items_title">
                ...
                <div class="stt_bestitems">베스트 아이템</div>
            </div>
                ...
                <div class="product_contents">
                    <div class="pr_con_01">
                        ...
                        <div class="product_name">
                            비에시스 어드밴스드 링클 앤 퍼밍 듀오
                        </div>
                    </div>
                    <div class="pr_con_02">
                        <div class="pr_price">
                            <div class="price_text">회원가</div>
                            <div class="price_number">380,000<span class="won_b">원</span></div>
                        </div>
                        <div class="pr_ep">
                            <div class="ep_text">EP</div>
                            <div class="ep_number">304,000</div>
                        </div>
                        <div class="pr_size">
                            ...
                            <div class="size_dropdown">
                                ...
                                <div class="size_option">A 사이즈</div>
                                <div class="size_option">B 사이즈</div>
                                <div class="size_option">C 사이즈</div>
                                <div class="size_option">C 사이즈</div>
                                <div class="size_option">C 사이즈</div>
                            </div>
                        </div>
            ...
            <div class="product">
                ...
                <div class="product_contents">
                    ...
                    <div class="pr_con_02">
                        <div class="pr_price">
                            <div class="price_text">회원가</div>
                            <div class="price_number">49,000<span class="won_b">원</span></div>
                        </div>
                        <div class="pr_ep">
                            <div class="ep_text">EP</div>
                            <div class="ep_number">39,200</div>
                        </div>
                        <div class="pr_size">
                            <div class="size_btn">
                                <div class="size_text">옵션</div>
                                <div class="size_point">▼</div>
                            </div>
                            <div class="size_dropdown">
                                <div class="size_pick">-</div>
                                <div class="size_option">1호(화사한 베이지)</div>
                                <div class="size_option">2호(차분한 베이지)</div>
                            </div>
                        </div>
                        <div class="pr_quantity">
                            <div class="number_box">
            ...
            <div class="product">
                ...
                <div class="product_contents">
                    ...
                    <div class="pr_con_02">
                        <div class="pr_price">
                            <div class="price_text">회원가</div>
                            <div class="price_number">199,000<span class="won_b">원</span></div>
                        </div>
                        <div class="pr_ep">
                            <div class="ep_text">EP</div>
                            <div class="ep_number">159,200</div>
                        </div>
                        <div class="pr_size">
                            <div class="size_btn closeeyes">
                                <div class="size_text">사이즈</div>
